/**
 * Cluster topology map for the /app product surface.
 *
 * A COPY of components/visualization/D3DependencyGraph.js, not an import.
 *
 * That component renders the scenario pages backing USPTO App. No.
 * 19/641,446 and the pending NIW petition. Generalising it in place to serve
 * both surfaces would put those pages one refactor away from a regression
 * while the petition is live. The duplication is deliberate and temporary;
 * reconcile the two once the petition clears.
 */
